        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto text-center">
                    ...
                    <h5 class="textOnWhite">We strive to be a real life sounding board and support system for people that need guidance and very specific help depending on the diagnosis timeline.</h5>
                </div>
            </div>
