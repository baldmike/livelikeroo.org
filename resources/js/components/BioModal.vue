<template>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div v-if="sarahLauch" class="col-xl-12 ml-auto mr-auto">
                ...
                <div v-if="lauraKrill" class="col-xl-6 col-lg-7 ml-auto mr-auto">
                    <card type="profile" plain>
                        <div slot="raw-content" class="row">
                            <div class="col-md-5">
                                <div class="card-image">
                ...
                <div v-if="nicoleCadwell" class="col-xl-6 col-lg-7 ml-auto mr-auto">
                    <card type="profile" plain>
                        <div slot="raw-content" class="row">
                            <div class="col-md-5">
                                <div class="card-image">
                ...
                <div v-if="kathyLesinski" class="col-xl-6 col-lg-7 ml-auto mr-auto">
                    <card type="profile" plain>
                        <div slot="raw-content" class="row">
                            <div class="col-md-5">
                                <div class="card-image">
                ...
                <div v-if="saraDePasquale" class="col-xl-6 col-lg-7 ml-auto mr-auto">
                    <card type="profile" plain>
                        <div slot="raw-content" class="row">
                            <div class="col-md-5">
                                <div class="card-image">
                ...
                <div v-if="dawnMueller" class="col-xl-6 col-lg-7 ml-auto mr-auto">
                    <card type="profile" plain>
                        <div slot="raw-content" class="row">
                            <div class="col-md-5">
                                <div class="card-image">
                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                    ...
                                    <p class="card-description textOnWhite">
                                        ...
                                        <n-button type="primary" @click.prevent.native="showBio">...Read Full Bio</n-button>
                ...
                <div v-if="lindsayGriffith" class="col-xl-6 col-lg-7 ml-auto mr-auto">
                    <card type="profile" plain>
                        <div slot="raw-content" class="row">
                            <div class="col-md-5">
                                <div class="card-image">
...
<script>
  ...
  export default {
    ...
    computed: {
        sarahLauch() {
            return this.$store.state.bio.sarah;
        },
        dawnMueller() {
            return this.$store.state.bio.dawn;
        },
        lauraKrill() {
            return this.$store.state.bio.laura;
        },
        nicoleCadwell() {
            return this.$store.state.bio.nicole;
        },
        kathyLesinski() {
            return this.$store.state.bio.kathy;
        },
        saraDePasquale() {
            return this.$store.state.bio.sara;
        },
        lindsayGriffith() {
            return this.$store.state.bio.lindsay;
        }
